...
from exchange.models import (
    ...
    UrgencyType, ImageModel, EquipmentApplication,
)
from product.api.serializers import RecyclablesSerializer, EquipmentSerializer
...
class CompanyRecyclablesSerializer(
    # Убирает все нулевые поля из представления
    NonNullDynamicFieldsModelSerializer):
...
class SubscribeCompanySerializer(NonNullDynamicFieldsModelSerializer):
    ...
    class Meta:
        ...
        fields = (
        'id', 'payment_number', 'payment_access', 'time_begin', 'time_end', 'companies', 'subscribe', 'is_deleted', 'company')
