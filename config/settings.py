...
SECRET_KEY = "fffdfsfdsfsdgdfhtrhtry"  # os.environ["DJANGO_SECRET_KEY"] исправить!!!!

# SECURITY WARNING: don't run with debug turned on in production!
DJANGO_ENV = os.getenv("DJANGO_ENV", "Development")
DEBUG = DJANGO_ENV != "Production"

ALLOWED_HOSTS = ['127.0.0.1', '217.12.38.44', 'localhost',
                 '62.217.178.142']  # os.environ["DJANGO_ALLOWED_HOSTS"].split(",") исправить!!!!
...
DB_ENGINE = 'postgres'  # os.environ["DB_ENGINE"] исправить!!!
...
BASE_URL = os.getenv("BASE_URL", "http://212.67.15.102:8000")  # "http://localhost:8000")
...
if DEBUG:
    ...
    INTERNAL_IPS = ["212.67.15.102", "127.0.0.1", "62.217.178.142"]  # ["127.0.0.1"]

# Подключение email-рассылки через yandex.ru
EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'

EMAIL_HOST = 'smtp.yandex.ru'
EMAIL_PORT = 465
EMAIL_HOST_USER = 'vtorprice.mail@yandex.ru'
EMAIL_HOST_PASSWORD = 'nqyudbgiggfktqsr'
EMAIL_USE_SSL = True
...
# Сервис whatsgate.ru подключен через телефон 89021584006 и email pavlovgrigorij@yandex.ru пароль Izual05140608Izual$

WHATSAPP_URL = 'https://whatsgate.ru/api/v1/send'
WHATSAPP_X_API_KEY = 'ErLuLaoIRgODGlkATy3CNzLqpou8gRIn'
WHATSAPP_ID = '67506a033c2f8'

# Сервис wappi.pro для подключения к api telegram 89021584006 email pavlovgrigorij@yandex.ru пароль Izual05140608Izual$

TELEGRAM_URL = 'https://wappi.pro/mailings/init/send'
TELEGRAM_API_TOKEN = '829057d4cfa5725744320ef68101d722af0adb0e'
TELEGRAM_ID = 'd5d94664-d392'


# ЮКасса https://yookassa.ru/ для подключения платежей почта - pavlvogrigorij@yandex.ru пароль - Izual05140608Izual$

YOOKASSA_SDK_API_KEY_TEST = 'test_MTAyNTA2NzZMQDQOJn0OS3T2qk4nCWtgBh5InXI_GLw'

YOOKASSA_AUTH_API_KEY_TEST = 'test_maUjgg9pXB4TusVAXNe8UkT6x-CsdMPN-9xmEr05o_c'

YOOKASSA_TEST_SHOP_ID = '1025067'
