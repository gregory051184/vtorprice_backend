...
router.register(
    r"special_applications",
    views.SpecialViewSet,
    basename="special_applications",
)

router.register(
    r"companies_special_applications",
    views.SpecialApplicationsViewSet,
    basename="companies_special_applications",
)
